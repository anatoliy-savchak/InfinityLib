...
namespace iiInfinityEngine.Core
{
    ...
    public static class Common
    {
        ...
        public static HeaderBinary ReadProbe(BinaryReader br)
        {
            Type t = typeof(HeaderBinary);
    ...
    public struct array32
    {
        ...
        public override string ToString()
        {
            var bb = new byte[]{(byte)character01, (byte)character02, (byte)character03, (byte)character04, (byte)character05, (byte)character06, (byte)character07, (byte)character08, (byte)character09, (byte)character10, (byte)character11,
                (byte)character12, (byte)character13, (byte)character14, (byte)character15, (byte)character16, (byte)character17, (byte)character18, (byte)character19, (byte)character20, (byte)character21, (byte)character22, (byte)character23,
                (byte)character24, (byte)character25, (byte)character26, (byte)character27, (byte)character28, (byte)character29, (byte)character30, (byte)character31, (byte)character32 };
            int len = 0;
            foreach (var b in bb)
                if (b == 0)
                    break;
                else len += 1;
            return System.Text.Encoding.ASCII.GetString(bb, 0, len);
