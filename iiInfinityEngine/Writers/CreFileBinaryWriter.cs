...
namespace iiInfinityEngine.Core.Writers
{
    public class CreFileBinaryWriter : ICreFileWriter
    {
        ...
        public bool Write(string filename, IEFile file, bool forceSave = false)
        {
            ...
            header.Animation = (Int16)creFile.Animation;
            ...
            header.SaveVsWanrds = creFile.SaveVsWands;
            ...
            header.TurnUndeadLevel = creFile.TurnUndeadLevel;
